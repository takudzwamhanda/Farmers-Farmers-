  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Tomato Farming</h1>
      </div>

      <div className="crop-content">
        <div className="crop-image-section">
          <img 
            src="/imgs/tomatoes.jpg" 
            alt="Tomato farming" 
        ...
        <div className="crop-info-grid">
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Plant Type:</strong> Annual herbaceous</li>
                <li><strong>Maturity Period:</strong> 60-100 days</li>
                <li><strong>Lifespan:</strong> Annual crop</li>
                <li><strong>Height:</strong> 1-3 meters</li>
                <li><strong>Spacing:</strong> 0.5-1 meter apart</li>
              </ul>
            </div>
          </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Harvesting:</strong> 60-100 days after planting</li>
                <li><strong>Pruning:</strong> Remove suckers regularly</li>
          ...
          <div className="crop-card full-width">
            ...
            <div className="crop-card-content">
              <div className="practices-grid">
                ...
                <div className="practice-item">
                  <h4>Fertilization</h4>
                  <p>Apply balanced NPK fertilizer and organic matter. Calcium is important for fruit quality.</p>
                </div>
                <div className="practice-item">
                  <h4>Pest Management</h4>
                  <p>Monitor for tomato fruitworms, aphids, and fungal diseases. Use integrated pest management.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="crop-card full-width">
            ...
            <div className="crop-card-content">
              <div className="market-info">
                ...
                <div className="market-item">
                  <h4>Processing</h4>
                  <p>Tomato paste, sauce, ketchup, and juice production</p>
                </div>
              </div>
            </div>
          </div>
