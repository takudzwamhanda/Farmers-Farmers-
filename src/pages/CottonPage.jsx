  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Cotton Farming</h1>
      </div>
        ...
        <div className="crop-info-grid">
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Plant Type:</strong> Annual shrub</li>
                <li><strong>Maturity Period:</strong> 150-180 days</li>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Rainfall:</strong> 700-1000mm per season</li>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Harvesting:</strong> 150-180 days after planting</li>
            ...
            <div className="crop-card-content">
              <div className="practices-grid">
                ...
                <div className="practice-item">
                  ...
                  <p>Monitor for bollworms, aphids, and fungal diseases. Use integrated pest management.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="crop-card-content">
              <div className="market-info">
                <div className="market-item">
                  <h4>Local Market</h4>
                  <p>High demand for textile industry and local markets</p>
                </div>
                <div className="market-item">
                  <h4>Export Potential</h4>
                  <p>Export opportunities for raw cotton and textile products</p>
                </div>
                <div className="market-item">
                  <h4>Processing</h4>
                  <p>Textile manufacturing, cottonseed oil, and animal feed production</p>
                </div>
              </div>
            </div>
          </div>
