  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Cattle Farming</h1>
      </div>
        ...
        <div className="crop-info-grid">
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Animal Type:</strong> Large ruminant</li>
                <li><strong>Gestation Period:</strong> 280-285 days</li>
                <li><strong>Life Span:</strong> 15-25 years</li>
                <li><strong>Maturity:</strong> 18-24 months</li>
                <li><strong>Weight Range:</strong> 400-800kg (cows)</li>
              </ul>
            </div>
          </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Space:</strong> 1-2 acres per animal</li>
              </ul>
            </div>
          </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Daily Water:</strong> 30-50 liters</li>
                <li><strong>Feed Type:</strong> Grass, hay, silage</li>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Calving:</strong> 9 months after breeding</li>
            ...
            <div className="crop-card-content">
              <div className="market-info">
                <div className="market-item">
                  <h4>Local Market</h4>
                  <p>High demand for beef, dairy products, and breeding stock</p>
                </div>
                <div className="market-item">
                  <h4>Export Potential</h4>
                  <p>Export opportunities for live animals, beef, and dairy products</p>
                </div>
                <div className="market-item">
                  <h4>Value Addition</h4>
                  <p>Meat processing, dairy products, leather, and fertilizer production</p>
                </div>
              </div>
            </div>
          </div>
