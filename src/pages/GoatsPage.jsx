  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Goat Farming</h1>
      </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Weight Range:</strong> 25-80kg</li>
              </ul>
            </div>
          </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Space:</strong> 10-15 sq meters per goat</li>
              </ul>
            </div>
          </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Kidding:</strong> 5 months after breeding</li>
            ...
            <div className="crop-card-content">
              <div className="market-info">
                <div className="market-item">
                  <h4>Local Market</h4>
                  <p>High demand for meat, milk, and breeding stock</p>
                </div>
                <div className="market-item">
                  <h4>Export Potential</h4>
                  <p>Export opportunities for live animals and goat products</p>
                </div>
                <div className="market-item">
                  <h4>Value Addition</h4>
                  <p>Meat processing, dairy products, leather, and manure</p>
                </div>
              </div>
            </div>
          </div>
