  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Round Nuts (Bambara Groundnuts) Farming</h1>
      </div>

      <div className="crop-content">
        <div className="crop-image-section">
          <img 
            src="/imgs/round nuts.jpg" 
            alt="Round nuts farming" 
        ...
        <div className="crop-info-grid">
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Plant Type:</strong> Annual legume</li>
                <li><strong>Maturity Period:</strong> 120-150 days</li>
                <li><strong>Lifespan:</strong> Annual crop</li>
                <li><strong>Height:</strong> 0.3-0.6 meters</li>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Flowering:</strong> 40-60 days after planting</li>
                <li><strong>Harvesting:</strong> 120-150 days after planting</li>
          ...
          <div className="crop-card full-width">
            ...
            <div className="crop-card-content">
              <div className="practices-grid">
                ...
                <div className="practice-item">
                  <h4>Irrigation</h4>
                  <p>Maintain consistent soil moisture throughout growth cycle. Avoid waterlogging which can cause pod rot.</p>
                </div>
                <div className="practice-item">
                  <h4>Fertilization</h4>
                  <p>Apply balanced NPK fertilizer and organic matter. Phosphorus is important for pod development.</p>
                </div>
                <div className="practice-item">
                  <h4>Pest Management</h4>
                  <p>Monitor for pod borers, aphids, and fungal diseases. Use integrated pest management.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="crop-card-content">
              <div className="market-info">
                ...
                <div className="market-item">
                  ...
                  <p>Export opportunities for raw nuts and processed products</p>
                </div>
                <div className="market-item">
                  <h4>Processing</h4>
                  <p>Roasted nuts, flour, and processed food products</p>
                </div>
              </div>
            </div>
          </div>
