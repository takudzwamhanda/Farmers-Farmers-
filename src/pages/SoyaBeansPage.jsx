  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Soya Beans Farming</h1>
      </div>

      <div className="crop-content">
        <div className="crop-image-section">
          <img 
            src="/imgs/soya beans.jpg" 
            alt="Soya beans farming" 
            ...
            <div className="crop-card-content">
              <div className="practices-grid">
                ...
                <div className="practice-item">
                  ...
                  <p>Monitor for soybean borers, aphids, and fungal diseases. Use integrated pest management.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="crop-card-content">
              <div className="market-info">
                <div className="market-item">
                  <h4>Local Market</h4>
                  <p>High demand for animal feed and local markets</p>
                </div>
                <div className="market-item">
                  <h4>Export Potential</h4>
                  <p>Export opportunities for raw soybeans and processed products</p>
                </div>
                <div className="market-item">
                  <h4>Processing</h4>
                  <p>Soybean oil, meal, tofu, and processed food products</p>
                </div>
              </div>
            </div>
          </div>
