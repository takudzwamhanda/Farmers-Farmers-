  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Maize (Corn) Farming</h1>
      </div>
      ...
      <div className="crop-content">
        ...
        <div className="crop-info-grid">
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Height:</strong> 2-3 meters</li>
                <li><strong>Spacing:</strong> 0.25-0.5 meters apart</li>
              </ul>
            </div>
          </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Rainfall:</strong> 500-800mm per season</li>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>pH Level:</strong> 5.5-7.5</li>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Planting:</strong> October - December</li>
                <li><strong>Flowering:</strong> 50-70 days after planting</li>
            ...
            <div className="crop-card-content">
              <div className="practices-grid">
                <div className="practice-item">
                  <h4>Planting</h4>
                  <p>Plant seeds in well-prepared soil at proper depth and spacing. Ensure good seed-to-soil contact.</p>
                </div>
                <div className="practice-item">
                  <h4>Irrigation</h4>
                  <p>Maintain consistent soil moisture, especially during flowering and grain filling stages.</p>
                </div>
                <div className="practice-item">
                  <h4>Fertilization</h4>
                  <p>Apply balanced NPK fertilizer. Nitrogen is crucial for vegetative growth and grain development.</p>
                </div>
                <div className="practice-item">
                  <h4>Pest Management</h4>
                  <p>Monitor for maize stalk borers, fall armyworms, and fungal diseases. Use integrated pest management.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="crop-card-content">
              <div className="market-info">
                <div className="market-item">
                  <h4>Local Market</h4>
                  <p>High demand for human consumption, animal feed, and industrial uses</p>
                </div>
                <div className="market-item">
                  <h4>Export Potential</h4>
                  <p>Export opportunities to regional markets and international markets</p>
                </div>
                <div className="market-item">
                  <h4>Processing</h4>
                  <p>Corn meal, flour, starch, ethanol, and animal feed production</p>
                </div>
              </div>
            </div>
          </div>
