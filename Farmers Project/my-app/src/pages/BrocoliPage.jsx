  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Broccoli Farming</h1>
      </div>

      <div className="crop-content">
        <div className="crop-image-section">
          <img 
            src="/imgs/brocoli.jpg" 
            alt="Broccoli farming" 
        ...
        <div className="crop-info-grid">
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Plant Type:</strong> Biennial vegetable</li>
                <li><strong>Maturity Period:</strong> 70-100 days</li>
                <li><strong>Lifespan:</strong> Biennial</li>
                <li><strong>Height:</strong> 0.5-1 meter</li>
                <li><strong>Spacing:</strong> 0.4-0.6 meters apart</li>
              </ul>
            </div>
          </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Harvesting:</strong> 70-100 days after planting</li>
            ...
            <div className="crop-card-content">
              <div className="practices-grid">
                ...
                <div className="practice-item">
                  ...
                  <p>Monitor for cabbage worms, aphids, and fungal diseases. Use integrated pest management.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="crop-card full-width">
            ...
            <div className="crop-card-content">
              <div className="market-info">
                ...
                <div className="market-item">
                  <h4>Processing</h4>
                  <p>Frozen broccoli, puree, and processed food products</p>
                </div>
              </div>
            </div>
          </div>
