  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Piggery (Pig Farming)</h1>
      </div>
        ...
        <div className="crop-info-grid">
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Animal Type:</strong> Domestic pig</li>
                <li><strong>Gestation Period:</strong> 114 days</li>
                <li><strong>Life Span:</strong> 15-20 years</li>
                <li><strong>Maturity:</strong> 6-8 months</li>
                <li><strong>Weight Range:</strong> 100-300kg (adults)</li>
              </ul>
            </div>
          </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Space:</strong> 8-12 sq ft per pig</li>
              </ul>
            </div>
          </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Daily Water:</strong> 10-15 liters</li>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Farrowing:</strong> 114 days after breeding</li>
                <li><strong>Vaccination:</strong> Every 6 months</li>
                <li><strong>Deworming:</strong> Every 3 months</li>
            ...
            <div className="crop-card-content">
              <div className="practices-grid">
                <div className="practice-item">
                  <h4>Housing</h4>
                  <p>Provide clean, well-ventilated pens with proper drainage and bedding. Ensure adequate space per animal.</p>
                </div>
                <div className="practice-item">
                  <h4>Feeding</h4>
            ...
            <div className="crop-card-content">
              <div className="market-info">
                <div className="market-item">
                  <h4>Local Market</h4>
                  <p>High demand for pork meat and breeding stock</p>
                </div>
                <div className="market-item">
                  <h4>Export Potential</h4>
                  <p>Export opportunities for live animals and pork products</p>
                </div>
                <div className="market-item">
                  <h4>Value Addition</h4>
                  <p>Meat processing, sausages, bacon, and leather products</p>
                </div>
              </div>
            </div>
          </div>
