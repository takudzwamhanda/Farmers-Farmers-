  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Okra Farming</h1>
      </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Maturity Period:</strong> 50-65 days</li>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Harvesting:</strong> 50-65 days after planting</li>
            ...
            <div className="crop-card-content">
              <div className="practices-grid">
                ...
                <div className="practice-item">
                  ...
                  <p>Monitor for okra beetles, aphids, and fungal diseases. Use integrated pest management.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="crop-card full-width">
            ...
            <div className="crop-card-content">
              <div className="market-info">
                ...
                <div className="market-item">
                  <h4>Processing</h4>
                  <p>Frozen okra, pickles, and processed food products</p>
                </div>
              </div>
            </div>
          </div>
