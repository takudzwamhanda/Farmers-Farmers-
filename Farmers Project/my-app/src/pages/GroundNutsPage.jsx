  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Ground Nuts (Peanuts) Farming</h1>
      </div>

      <div className="crop-content">
        <div className="crop-image-section">
          <img 
            src="/imgs/ground nuts.jpg" 
            alt="Ground nuts farming" 
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Flowering:</strong> 30-40 days after planting</li>
            ...
            <div className="crop-card-content">
              <div className="practices-grid">
                ...
                <div className="practice-item">
                  ...
                  <p>Monitor for peanut borers, aphids, and fungal diseases. Use integrated pest management.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="crop-card-content">
              <div className="market-info">
                ...
                <div className="market-item">
                  ...
                  <p>Export opportunities for raw peanuts and processed products</p>
                </div>
                <div className="market-item">
                  <h4>Processing</h4>
                  <p>Peanut butter, oil, roasted peanuts, and processed food products</p>
                </div>
              </div>
            </div>
          </div>
