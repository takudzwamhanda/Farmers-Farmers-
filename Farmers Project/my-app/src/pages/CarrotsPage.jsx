  ...
  return (
    <div className="crop-page">
      <div className="crop-page-header">
        ...
        <h1 className="crop-title">Carrot Farming</h1>
      </div>

      <div className="crop-content">
        <div className="crop-image-section">
          <img 
            src="/imgs/carrots.jpg" 
            alt="Carrot farming" 
        ...
        <div className="crop-info-grid">
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Plant Type:</strong> Biennial root vegetable</li>
                <li><strong>Maturity Period:</strong> 70-80 days</li>
                <li><strong>Lifespan:</strong> Biennial</li>
                <li><strong>Height:</strong> 0.3-0.6 meters</li>
                <li><strong>Spacing:</strong> 0.1-0.2 meters apart</li>
              </ul>
            </div>
          </div>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                <li><strong>Soil Type:</strong> Loose, well-drained sandy loam</li>
          ...
          <div className="crop-card">
            ...
            <div className="crop-card-content">
              <ul>
                ...
                <li><strong>Germination:</strong> 7-14 days</li>
                <li><strong>Harvesting:</strong> 70-80 days after planting</li>
            ...
            <div className="crop-card-content">
              <div className="practices-grid">
                <div className="practice-item">
                  <h4>Planting</h4>
                  <p>Plant seeds in well-prepared, loose soil. Ensure proper spacing for root development.</p>
                </div>
                <div className="practice-item">
                  <h4>Irrigation</h4>
                  <p>Maintain consistent soil moisture throughout growth. Avoid waterlogging which can cause root rot.</p>
                </div>
                <div className="practice-item">
                  <h4>Fertilization</h4>
                  <p>Apply balanced NPK fertilizer and organic matter. Phosphorus is important for root development.</p>
                </div>
                <div className="practice-item">
                  <h4>Pest Management</h4>
                  <p>Monitor for carrot rust fly, aphids, and fungal diseases. Use integrated pest management.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="crop-card full-width">
            ...
            <div className="crop-card-content">
              <div className="market-info">
                ...
                <div className="market-item">
                  <h4>Processing</h4>
                  <p>Carrot juice, puree, canned carrots, and baby food production</p>
                </div>
              </div>
            </div>
          </div>
